...
export const WhiteboardFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WhiteboardFindFirstOrThrowArgs> = z.object({
...
export default WhiteboardFindFirstOrThrowArgsSchema;
