...
export const PluginSettingsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.PluginSettingsFindFirstOrThrowArgs> = z.object({
...
export default PluginSettingsFindFirstOrThrowArgsSchema;
