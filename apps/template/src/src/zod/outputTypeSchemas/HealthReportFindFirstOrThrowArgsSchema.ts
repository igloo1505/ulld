...
export const HealthReportFindFirstOrThrowArgsSchema: z.ZodType<Prisma.HealthReportFindFirstOrThrowArgs> = z.object({
...
export default HealthReportFindFirstOrThrowArgsSchema;
