...
export const PluginSettingsFindUniqueArgsSchema: z.ZodType<Prisma.PluginSettingsFindUniqueArgs> = z.object({
  select: PluginSettingsSelectSchema.optional(),
  where: PluginSettingsWhereUniqueInputSchema,
}).strict() ;

export default PluginSettingsFindUniqueArgsSchema;
