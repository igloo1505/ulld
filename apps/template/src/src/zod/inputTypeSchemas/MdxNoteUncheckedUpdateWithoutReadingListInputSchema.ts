...
export const MdxNoteUncheckedUpdateWithoutReadingListInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateWithoutReadingListInput> = z.object({
...
export default MdxNoteUncheckedUpdateWithoutReadingListInputSchema;
