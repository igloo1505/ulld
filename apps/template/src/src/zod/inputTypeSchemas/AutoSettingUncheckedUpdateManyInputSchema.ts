...
export const AutoSettingUncheckedUpdateManyInputSchema: z.ZodType<Prisma.AutoSettingUncheckedUpdateManyInput> = z.object({
...
export default AutoSettingUncheckedUpdateManyInputSchema;
