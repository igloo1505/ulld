...
export const EquationUncheckedCreateNestedManyWithoutTopicsInputSchema: z.ZodType<Prisma.EquationUncheckedCreateNestedManyWithoutTopicsInput> = z.object({
...
export default EquationUncheckedCreateNestedManyWithoutTopicsInputSchema;
