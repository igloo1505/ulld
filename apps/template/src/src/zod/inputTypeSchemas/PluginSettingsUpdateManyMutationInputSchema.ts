...
export const PluginSettingsUpdateManyMutationInputSchema: z.ZodType<Prisma.PluginSettingsUpdateManyMutationInput> = z.object({
...
export default PluginSettingsUpdateManyMutationInputSchema;
