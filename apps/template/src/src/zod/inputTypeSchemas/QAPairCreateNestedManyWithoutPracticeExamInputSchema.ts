...
export const QAPairCreateNestedManyWithoutPracticeExamInputSchema: z.ZodType<Prisma.QAPairCreateNestedManyWithoutPracticeExamInput> = z.object({
...
export default QAPairCreateNestedManyWithoutPracticeExamInputSchema;
