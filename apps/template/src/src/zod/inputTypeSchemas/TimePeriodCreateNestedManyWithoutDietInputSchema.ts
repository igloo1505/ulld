...
export const TimePeriodCreateNestedManyWithoutDietInputSchema: z.ZodType<Prisma.TimePeriodCreateNestedManyWithoutDietInput> = z.object({
...
export default TimePeriodCreateNestedManyWithoutDietInputSchema;
