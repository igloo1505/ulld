...
export const DietUpdateWithoutHealthReportInputSchema: z.ZodType<Prisma.DietUpdateWithoutHealthReportInput> = z.object({
...
export default DietUpdateWithoutHealthReportInputSchema;
