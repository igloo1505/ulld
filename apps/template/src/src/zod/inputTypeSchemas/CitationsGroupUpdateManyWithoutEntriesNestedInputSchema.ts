...
export const CitationsGroupUpdateManyWithoutEntriesNestedInputSchema: z.ZodType<Prisma.CitationsGroupUpdateManyWithoutEntriesNestedInput> = z.object({
...
export default CitationsGroupUpdateManyWithoutEntriesNestedInputSchema;
