...
export const SubjectCreateNestedManyWithoutEquationsInputSchema: z.ZodType<Prisma.SubjectCreateNestedManyWithoutEquationsInput> = z.object({
...
export default SubjectCreateNestedManyWithoutEquationsInputSchema;
