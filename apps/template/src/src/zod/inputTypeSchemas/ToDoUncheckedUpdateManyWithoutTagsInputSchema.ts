...
export const ToDoUncheckedUpdateManyWithoutTagsInputSchema: z.ZodType<Prisma.ToDoUncheckedUpdateManyWithoutTagsInput> = z.object({
...
export default ToDoUncheckedUpdateManyWithoutTagsInputSchema;
