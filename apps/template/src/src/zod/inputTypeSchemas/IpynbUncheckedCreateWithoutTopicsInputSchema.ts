...
export const IpynbUncheckedCreateWithoutTopicsInputSchema: z.ZodType<Prisma.IpynbUncheckedCreateWithoutTopicsInput> = z.object({
...
export default IpynbUncheckedCreateWithoutTopicsInputSchema;
