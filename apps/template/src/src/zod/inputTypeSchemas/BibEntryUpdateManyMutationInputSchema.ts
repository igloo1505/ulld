...
export const BibEntryUpdateManyMutationInputSchema: z.ZodType<Prisma.BibEntryUpdateManyMutationInput> = z.object({
...
export default BibEntryUpdateManyMutationInputSchema;
