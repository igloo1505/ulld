...
export const MdxNoteCreateWithoutDefinitionsInputSchema: z.ZodType<Prisma.MdxNoteCreateWithoutDefinitionsInput> = z.object({
...
export default MdxNoteCreateWithoutDefinitionsInputSchema;
