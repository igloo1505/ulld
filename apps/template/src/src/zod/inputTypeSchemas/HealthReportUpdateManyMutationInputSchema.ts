...
export const HealthReportUpdateManyMutationInputSchema: z.ZodType<Prisma.HealthReportUpdateManyMutationInput> = z.object({
...
export default HealthReportUpdateManyMutationInputSchema;
