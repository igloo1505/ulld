...
export const IpynbUncheckedUpdateManyInputSchema: z.ZodType<Prisma.IpynbUncheckedUpdateManyInput> = z.object({
...
export default IpynbUncheckedUpdateManyInputSchema;
