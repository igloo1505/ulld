...
export const EquationUncheckedCreateWithoutSubjectsInputSchema: z.ZodType<Prisma.EquationUncheckedCreateWithoutSubjectsInput> = z.object({
...
export default EquationUncheckedCreateWithoutSubjectsInputSchema;
