...
export const QAPairUncheckedCreateNestedManyWithoutTopicsInputSchema: z.ZodType<Prisma.QAPairUncheckedCreateNestedManyWithoutTopicsInput> = z.object({
...
export default QAPairUncheckedCreateNestedManyWithoutTopicsInputSchema;
