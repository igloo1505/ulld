...
export const BibEntryCountOrderByAggregateInputSchema: z.ZodType<Prisma.BibEntryCountOrderByAggregateInput> = z.object({
...
export default BibEntryCountOrderByAggregateInputSchema;
