...
export const PluginSettingsUncheckedUpdateManyInputSchema: z.ZodType<Prisma.PluginSettingsUncheckedUpdateManyInput> = z.object({
...
export default PluginSettingsUncheckedUpdateManyInputSchema;
