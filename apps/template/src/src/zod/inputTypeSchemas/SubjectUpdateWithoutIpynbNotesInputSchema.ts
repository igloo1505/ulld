...
export const SubjectUpdateWithoutIpynbNotesInputSchema: z.ZodType<Prisma.SubjectUpdateWithoutIpynbNotesInput> = z.object({
...
export default SubjectUpdateWithoutIpynbNotesInputSchema;
