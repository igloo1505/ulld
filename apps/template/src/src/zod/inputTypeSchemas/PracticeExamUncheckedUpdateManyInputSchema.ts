...
export const PracticeExamUncheckedUpdateManyInputSchema: z.ZodType<Prisma.PracticeExamUncheckedUpdateManyInput> = z.object({
...
export default PracticeExamUncheckedUpdateManyInputSchema;
