...
export const EquationUncheckedUpdateManyInputSchema: z.ZodType<Prisma.EquationUncheckedUpdateManyInput> = z.object({
...
export default EquationUncheckedUpdateManyInputSchema;
