...
export const corePluginsFeature: FeaturedContainerPropsRequired = {
    ...
    desc: () => {
        return (
            <div className={"w-full flex flex-col justify-center items-start gap-4 group-[.flow]/feature:gap-8"}>
                <span>
                ...
                <Link className={buttonVariants({})} href="/gravity">His Notes</Link>
            </div>
        );
    },
    component: ({ shouldShow, orientation }) => {
