...
const MDXArticle = forwardRef(
    (
        ...
        return (
            <div className={"w-full text-center px-12 text-8xl"}>
                This <span className={"bg-primary text-primary-foreground"}>NEEDS</span> to be replaced ASAP. Moved away from next-contentlayer and on to fumadocs, so replace this accordingly.
            </div>
        )
