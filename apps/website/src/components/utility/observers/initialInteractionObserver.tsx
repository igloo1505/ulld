...
const InitialInteractionObserver = (props: InitialInteractionObserverProps) => {
  const [hasShown, setHasShown]: [boolean | string, (val: boolean) => void] = useLocalStorage(
    "have-begged-for-sponsorship",
    false,
    {
  ...
  const showLaunchSponsorReq = () => {
    ...
    /* setHasShown(true); */ // Turn this back on
  };
  useEffect(() => {
