...
import { Camera, Canvas, ThreeElements, Vector2, useLoader, useThree } from "@react-three/fiber";
...
const NoiseyBlobInternal = (props: NoiseyBlobProps) => {
    ...
    useBlobAnimation({nucleus: nucleusRef, camera: cameraRef })
    ...
    return (
        <>
            ...
            <BlobNucleus ref={nucleusRef} texture={textureNucleus} geoData={section.geoData} />
