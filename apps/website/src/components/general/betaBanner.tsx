...
export const BetaBanner = () => {
    ...
    return (
        ...
        >
            ...
            This app is currently in beta. I encourage you to explore and check back
            often. While the app has been finished for months, the build script will
            be wrapping up in early July.
            </span>
        </motion.div>
    );
};
