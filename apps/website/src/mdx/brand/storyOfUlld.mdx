...
If you can, please consider supporting the development of <LogoAsText /> by clicking [here](https://www.paypal.com/donate/?hosted_button_id=W22RTUJ2RPZDU) or scanning the QR code below, and if you're interested in physics and cosmology, checkout inspiration for <LogoAsText /> [here](/myWork?id=onTheGravitationalNatureOfTime). <LogoAsText /> was never created to be for sale, but in the pursuit of this theory I became homeless, and as I'm writing this, I don't have a penny to fill up my gas tank so I can run my car to charge my computer to finish the last 3% of preparing <LogoAsText /> for release.
