...
> The Earth's polar radius was used in the calculation above. Using the Earth's equatorial radius reduces the discrepancy between this result and the derived velocity with respect to the CMB dipole to $0.72\%$.
