...
> Note that this is currently being revised. An updated revised version will be available sometime before 10-20-24.
...
<Admonition title="In regards to $\bar{v}$" type="info" dropdown open>
...
[^12]: While the geometry of a temporal plane closely mirrors the geometry of a spherical surface for spherical gravitational sources of a uniform mass density, the _surface_ should not be thought of as 2-dimensional, but rather of a spherical surface with a small, but significant third dimension along the radial axis.
