...
<Admonition title="Status" type="note" center>
    This article is currently being revised. An updated revised version will be available soon.
</Admonition>
...
$$
\begin{align}
v = \frac{ds}{dt_p} \tau_\epsilon
\end{align}
$$

As $ds = dx_{\bar{v}} \frac{g}{\bar{v}}$ and $\tau_o = \frac{1}{dt}$, we should find this equivalence as

$$
\begin{align}
 v = ds \tau_\epsilon \tau_o
\end{align}
$$
...
$$
\begin{align}
 v = \overbrace{dx_{\bar{v}} \left( \frac{g}{\bar{v}} \right)}^{\text{ds}} \underbrace{\left( \frac{\bar{v}}{dx_{\bar{v}}} \right)}_{\tau_\epsilon} \overbrace{\left( \frac{h}{c} \right)}^{\tau_o}
\end{align}
$$

Simplified, this then gives the findings by Pound and Rebka as:

$$
\begin{align}
v = \cancel{dx_{\bar{v}}} \frac{g}{\cancel{\bar{v}}} \frac{\cancel{\bar{v}}}{\cancel{dx_{\bar{v}}}} \frac{h}{c} = g \frac{h}{c}
\end{align}
$$
