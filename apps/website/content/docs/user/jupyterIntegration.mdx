...
If you can, please consider helping speed up this process by supporting the development of <LogoAsText /> through any of the means available [here](/sponsor). As you can imagine, having access to a power outlet and an internet connection would be quite a game changer... like Jamie Tart going back to Richmond.[^1]
