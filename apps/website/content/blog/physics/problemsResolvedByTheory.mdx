...
This would fit closely with the reference frame dependence described [here](/blog/physics/centerOfMassShift), where an observer that is traveling with the source of spatial dilation experiences the dilation in a different manner from the observer experiencing the spatial dilation caused by a second body.
