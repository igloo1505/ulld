...
- Spread the word about <LogoAsText /> on your socials! I've created a [Discord server](https://discord.gg/FUA88wwqUM) and a [Twitter account](https://x.com/uhlittlelessdum), but if you're active on social media, help other people discover <LogoAsText /> for themselves.
...
- Obviously, if you can, and only if you can, please consider supporting the development of <LogoAsText /> through the shameless plug above.
</Admonition>
