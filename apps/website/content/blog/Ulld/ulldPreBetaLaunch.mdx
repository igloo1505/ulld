...
- Spread the word about <LogoAsText /> on your socials! I've created a [Discord server](https://discord.gg/FUA88wwqUM) and a Twitter account [@uhlittlelessdum](https://x.com/uhlittlelessdum) to interact with users directly, but if you're active on social media, help other people discover <LogoAsText /> for themselves.
