...
- Obviously, if you can, and only if you can, please consider supporting the development of <LogoAsText /> through the shameless plug above. Asking for financial support feels gross, but having a more stable work environment would allow me to improve <LogoAsText /> at literally 10-20x the current pace.
</Admonition>
