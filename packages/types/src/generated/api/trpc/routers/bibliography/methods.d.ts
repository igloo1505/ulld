...
export declare const getBibWithEntries: (bibId?: number) => Promise<({
    entries: ({
        tags: {
            value: string;
...
export declare const getBibItemWithAll: (id: string) => Promise<({
    tags: {
        value: string;
        kanbanId: number | null;
    }[];
...
export declare const getBibFilename: (input?: number) => Promise<string | {
    filename: string;
} | undefined>;
