...
export declare const updateMdxNote: (note: MdxNote, autoSettings: AutoSettingWithRegex[] | undefined, config: ParsedAppConfig) => Promise<{
    id: number;
...
//# sourceMappingURL=updateMdx.d.ts.map