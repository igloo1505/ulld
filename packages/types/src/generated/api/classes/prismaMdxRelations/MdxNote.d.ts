...
export type MdxNoteParseParams = Pick<UnifiedMdxParserParams, "appConfig" | "docTypeData"> & {
...
export declare class MdxNote extends MdxNoteProtocol {
    ...
    static parseMdxString(content: string, opts: ParseMdxStringProps | undefined, parserParams: MdxNoteParseParams): Promise<string>;
    parse(params: MdxNoteParseParams): Promise<string>;
    ...
    static fromMdxString(props: MdxNoteFromStringInput, _opts: FromMdxStringOpts, parseParams: MdxNoteParseParams): Promise<MdxNote>;
