...
export declare const zodPathStringField: (desc?: string, optional?: boolean) => z.ZodEffects<z.ZodOptional<z.ZodString>, string | undefined, string | undefined> | z.ZodEffects<z.ZodString, string, string>;
