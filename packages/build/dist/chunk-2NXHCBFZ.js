...
// src/classes/baseClasses/shell.ts
init_esm_shims();
import cp from "child_process";
import chalk from "chalk";
var packageManagerExecution = {
  npm: "npm run",
  yarn: "yarn run",
  pnpm: "pnpm run"
};
var ShellManager = class {
  ...
  constructor() {
    if (process.env.ULLD_LOG_LEVEL && this.logLevelOrder.includes(process.env.ULLD_LOG_LEVEL)) {
...
//# sourceMappingURL=chunk-2NXHCBFZ.js.map