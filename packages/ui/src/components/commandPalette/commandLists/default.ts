...
interface CmdPaletteItem extends Omit<CommandPaletteItemProps, "activePage" | "close" | "children" | "value"> {
    label: string
    value: string
}

let factions: (CmdPaletteItem | false)[] = getInternalConfig().noteTypes.map((l: DocumentTypeConfig): CmdPaletteItem | false => {
...
export const formattedActions: CmdPaletteItem[] = factions.filter((a) => a) as CmdPaletteItem[]


export const defaultCommandList: CmdPaletteItem[] = [
    {
    ...
    },
    {
        ...
        onSelect: async () => {
            ...
            showToast({
                title: "Success",
                description: "Data that can not be re-generated from the filesystem has been backed up successfully."
            })
        },
        value: "backupdbonly"
    },
