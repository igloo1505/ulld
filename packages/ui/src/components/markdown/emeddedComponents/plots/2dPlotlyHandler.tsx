...
const TwoDPlotlyHandler = connector(({ data, layout, darkmode }: PlotlyHandlerProps<TwoDPlotTypes>) => {
...
TwoDPlotlyHandler.displayName = "TwoDPlotlyHandler"


export default TwoDPlotlyHandler;
