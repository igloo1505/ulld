...
export const SidebarButton = ({ item }: SidebarButtonProps) => {
    ...
    if (Icon === "darktoggle") {
        return (
            <a onClick={Icon === "darktoggle" ? toggleDarkMode : item.onClick} className="cursor-pointer p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg hover:bg-opacity-10 hover:bg-white bg-primary dark:bg-gray-950 dark:hover:bg-gray-700 text-primary-foreground">
