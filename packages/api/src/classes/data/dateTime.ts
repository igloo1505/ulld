...
export class DateTime {
    ...
    relativeTime(type: "descriptive" | "analog" | "summarized") {
        if (type === "analog") return this.replaceExtraNegatives(this.relativeTimeAnalog())
        if (type === "summarized") return this.replaceExtraNegatives(this.relativeTimeSummarized())
        if (type === "descriptive") return this.replaceExtraNegatives(this.relativeTimeDescriptive())
        return ""
    }
