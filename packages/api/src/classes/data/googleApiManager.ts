...
// TODO: Change this to work with prisma so users can use this feature without going into ulld/App directory.
export class GoogleApiManager extends CalendarAndDateManager {
    scopes: string[] = [
