...
export interface TaggableComboBoxProps<T extends FieldValues, H extends HTMLElement> extends BaseFullFormInputProps<T, H> {
    options: string[]
    emptyText?: string
    placeholder: string
    multiple?: boolean
...
export const TaggableComboBox = <T extends FieldValues>({ label, replaceUnderscores, desc, name, options, emptyText, displayTransform, placeholder, multiple, groupClasses, buttonClasses, formItemClasses }: TaggableComboBoxProps<T, HTMLTextAreaElement>) => {
