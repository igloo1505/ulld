...
interface MathStringInputProps extends Omit<EditableMathFieldProps, "onChange"> {
    value: string
...
export const MathInput = ({ value, onChange, ...props }: MathStringInputProps) => {
    useMemo(() => addStyles(), [])
    return (
        <EditableMathField
...
MathInput.displayName = "MathStringInput"
