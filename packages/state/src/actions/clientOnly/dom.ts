...
export const setToolTipAllow = (allow: boolean) => {
    ...
    store.dispatch(setAllowTooltips(allow))
}
...
export const setQuickLinkHtmlId = (id?: string) => id ? htmlEm()?.setAttribute("data-quickLinkId", id) : htmlEm()?.removeAttribute("data-quickLinkId")

export const getQuickLinkHtmlId = (): string | null => htmlEm()?.getAttribute("data-quickLinkId") || null
