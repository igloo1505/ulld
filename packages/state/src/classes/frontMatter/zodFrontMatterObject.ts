...
const fields: Record<keyof FrontMatterType<{}>, ZodTypeAny> = {
    ...
    updated: zodOptStr,
    summary: zodOptStr,
    subjects: z.union([z.string(), z.string().array()]).transform((a) => Array.isArray(a) ? a.map((l) => String(l)) : [String(a)]).default([]),
    topics: z.union([z.string(), z.string().array()]).transform((a) => Array.isArray(a) ? a.map((l) => String(l)) : [String(a)]).default([]),
    tags: z.union([z.string(), z.string().array()]).transform((a) => Array.isArray(a) ? a.map((l) => String(l)) : [String(a)]).default([]),
