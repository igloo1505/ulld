...
dev.genFileContent(
    ...
    {
        filePath:
            "packages/types/src/manualTypes/baseApp/state/internalActionIds.ts",
...
dev.genFileContent(
    ...
    defaultIcon: ValidIconNameDynamicallyGenerated
        ...
        },
        {
            ...
            props: {
                content: `import type { ValidIconNameDynamicallyGenerated, InternalGlobalActionIds } from "@ulld/types";\n\n`,
            },
        },
    ],
    {
