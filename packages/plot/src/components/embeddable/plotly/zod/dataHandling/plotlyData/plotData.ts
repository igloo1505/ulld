...
export const plotlyPlotDataSchema = z.object({
    ...
    lat: plotlyDatumSchema.optional(),
    lon: plotlyDatumSchema.optional(),
    ...
    stackgaps: z.union([z.literal("infer zero"), z.literal("interpolate")]).optional(),
    ...
    showscale: z.number().optional(), 
    colorscale: plotlyColorScaleSchema.optional(),
    zsmooth: z.union([z.literal("fast"), z.literal("best"), z.literal(false)]).optional(),
    ...
    branchvalues: z.union([z.literal("total"), z.literal("remainder")]).optional(),
