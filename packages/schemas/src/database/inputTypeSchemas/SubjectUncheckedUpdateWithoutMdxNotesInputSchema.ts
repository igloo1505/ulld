...
export const SubjectUncheckedUpdateWithoutMdxNotesInputSchema: z.ZodType<Prisma.SubjectUncheckedUpdateWithoutMdxNotesInput> = z.object({
...
export default SubjectUncheckedUpdateWithoutMdxNotesInputSchema;
