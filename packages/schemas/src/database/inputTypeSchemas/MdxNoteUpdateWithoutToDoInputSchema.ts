...
export const MdxNoteUpdateWithoutToDoInputSchema: z.ZodType<Prisma.MdxNoteUpdateWithoutToDoInput> = z.object({
...
export default MdxNoteUpdateWithoutToDoInputSchema;
