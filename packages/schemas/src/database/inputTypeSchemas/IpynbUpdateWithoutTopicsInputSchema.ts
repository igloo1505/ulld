...
export const IpynbUpdateWithoutTopicsInputSchema: z.ZodType<Prisma.IpynbUpdateWithoutTopicsInput> = z.object({
...
export default IpynbUpdateWithoutTopicsInputSchema;