...
export const TopicUpdateManyWithoutToDoNestedInputSchema: z.ZodType<Prisma.TopicUpdateManyWithoutToDoNestedInput> = z.object({
...
export default TopicUpdateManyWithoutToDoNestedInputSchema;
