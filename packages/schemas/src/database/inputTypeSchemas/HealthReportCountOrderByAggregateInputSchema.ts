...
export const HealthReportCountOrderByAggregateInputSchema: z.ZodType<Prisma.HealthReportCountOrderByAggregateInput> = z.object({
...
export default HealthReportCountOrderByAggregateInputSchema;
