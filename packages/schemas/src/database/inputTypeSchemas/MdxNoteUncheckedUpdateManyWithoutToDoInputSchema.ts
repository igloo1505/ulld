...
export const MdxNoteUncheckedUpdateManyWithoutToDoInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateManyWithoutToDoInput> = z.object({
...
export default MdxNoteUncheckedUpdateManyWithoutToDoInputSchema;
