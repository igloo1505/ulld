...
export const DietaryItemUncheckedCreateNestedManyWithoutDietInputSchema: z.ZodType<Prisma.DietaryItemUncheckedCreateNestedManyWithoutDietInput> = z.object({
...
export default DietaryItemUncheckedCreateNestedManyWithoutDietInputSchema;
