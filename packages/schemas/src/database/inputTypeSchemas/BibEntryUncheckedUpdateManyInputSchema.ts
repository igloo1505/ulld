...
export const BibEntryUncheckedUpdateManyInputSchema: z.ZodType<Prisma.BibEntryUncheckedUpdateManyInput> = z.object({
...
export default BibEntryUncheckedUpdateManyInputSchema;
