...
export const TopicUpdateManyWithoutBibEntriesNestedInputSchema: z.ZodType<Prisma.TopicUpdateManyWithoutBibEntriesNestedInput> = z.object({
...
export default TopicUpdateManyWithoutBibEntriesNestedInputSchema;
