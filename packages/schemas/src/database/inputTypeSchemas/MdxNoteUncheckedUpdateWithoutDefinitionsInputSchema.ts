...
export const MdxNoteUncheckedUpdateWithoutDefinitionsInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateWithoutDefinitionsInput> = z.object({
...
export default MdxNoteUncheckedUpdateWithoutDefinitionsInputSchema;
