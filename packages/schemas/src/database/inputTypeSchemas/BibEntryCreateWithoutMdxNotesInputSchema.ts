...
export const BibEntryCreateWithoutMdxNotesInputSchema: z.ZodType<Prisma.BibEntryCreateWithoutMdxNotesInput> = z.object({
  id: z.string(),
...
export default BibEntryCreateWithoutMdxNotesInputSchema;
