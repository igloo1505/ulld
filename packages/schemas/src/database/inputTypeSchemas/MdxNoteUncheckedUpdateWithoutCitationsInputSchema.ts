...
export const MdxNoteUncheckedUpdateWithoutCitationsInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateWithoutCitationsInput> = z.object({
...
export default MdxNoteUncheckedUpdateWithoutCitationsInputSchema;
