...
export const BibEntryUncheckedCreateNestedManyWithoutTopicsInputSchema: z.ZodType<Prisma.BibEntryUncheckedCreateNestedManyWithoutTopicsInput> = z.object({
...
export default BibEntryUncheckedCreateNestedManyWithoutTopicsInputSchema;
