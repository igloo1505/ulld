...
export const ServingUncheckedUpdateWithoutItemInputSchema: z.ZodType<Prisma.ServingUncheckedUpdateWithoutItemInput> = z.object({
...
export default ServingUncheckedUpdateWithoutItemInputSchema;
