...
export const SubjectUncheckedCreateNestedManyWithoutIpynbNotesInputSchema: z.ZodType<Prisma.SubjectUncheckedCreateNestedManyWithoutIpynbNotesInput> = z.object({
...
export default SubjectUncheckedCreateNestedManyWithoutIpynbNotesInputSchema;
