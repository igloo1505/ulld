...
export const BibEntryCreateWithoutTopicsInputSchema: z.ZodType<Prisma.BibEntryCreateWithoutTopicsInput> = z.object({
  id: z.string(),
...
export default BibEntryCreateWithoutTopicsInputSchema;
