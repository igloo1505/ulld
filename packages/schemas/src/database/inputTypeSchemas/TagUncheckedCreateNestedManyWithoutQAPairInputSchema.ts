...
export const TagUncheckedCreateNestedManyWithoutQAPairInputSchema: z.ZodType<Prisma.TagUncheckedCreateNestedManyWithoutQAPairInput> = z.object({
...
export default TagUncheckedCreateNestedManyWithoutQAPairInputSchema;
