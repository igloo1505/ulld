...
export const BibEntryUpdateWithoutBibInputSchema: z.ZodType<Prisma.BibEntryUpdateWithoutBibInput> = z.object({
...
export default BibEntryUpdateWithoutBibInputSchema;
