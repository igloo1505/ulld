...
export const MdxNoteCreateWithoutSubjectsInputSchema: z.ZodType<Prisma.MdxNoteCreateWithoutSubjectsInput> = z.object({
...
export default MdxNoteCreateWithoutSubjectsInputSchema;
