...
export const TagUpdateManyWithoutQAPairNestedInputSchema: z.ZodType<Prisma.TagUpdateManyWithoutQAPairNestedInput> = z.object({
...
export default TagUpdateManyWithoutQAPairNestedInputSchema;
