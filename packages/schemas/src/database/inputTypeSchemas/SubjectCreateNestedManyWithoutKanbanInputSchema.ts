...
export const SubjectCreateNestedManyWithoutKanbanInputSchema: z.ZodType<Prisma.SubjectCreateNestedManyWithoutKanbanInput> = z.object({
...
export default SubjectCreateNestedManyWithoutKanbanInputSchema;
