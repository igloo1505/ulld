...
export const MdxNoteUncheckedUpdateManyWithoutTopicsNestedInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateManyWithoutTopicsNestedInput> = z.object({
...
export default MdxNoteUncheckedUpdateManyWithoutTopicsNestedInputSchema;
