...
export const SubjectUncheckedCreateNestedManyWithoutTodoListInputSchema: z.ZodType<Prisma.SubjectUncheckedCreateNestedManyWithoutTodoListInput> = z.object({
...
export default SubjectUncheckedCreateNestedManyWithoutTodoListInputSchema;
