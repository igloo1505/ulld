...
export const BibEntryUncheckedCreateWithoutBibInputSchema: z.ZodType<Prisma.BibEntryUncheckedCreateWithoutBibInput> = z.object({
  id: z.string(),
...
export default BibEntryUncheckedCreateWithoutBibInputSchema;
