...
export const MdxNoteUncheckedUpdateManyWithoutSubjectsInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateManyWithoutSubjectsInput> = z.object({
...
export default MdxNoteUncheckedUpdateManyWithoutSubjectsInputSchema;
