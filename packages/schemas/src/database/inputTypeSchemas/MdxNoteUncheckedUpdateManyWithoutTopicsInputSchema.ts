...
export const MdxNoteUncheckedUpdateManyWithoutTopicsInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateManyWithoutTopicsInput> = z.object({
...
export default MdxNoteUncheckedUpdateManyWithoutTopicsInputSchema;
