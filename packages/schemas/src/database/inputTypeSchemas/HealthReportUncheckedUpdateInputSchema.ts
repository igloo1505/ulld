...
export const HealthReportUncheckedUpdateInputSchema: z.ZodType<Prisma.HealthReportUncheckedUpdateInput> = z.object({
...
export default HealthReportUncheckedUpdateInputSchema;
