...
export const BibUpdateWithoutEntriesInputSchema: z.ZodType<Prisma.BibUpdateWithoutEntriesInput> = z.object({
...
export default BibUpdateWithoutEntriesInputSchema;
