...
export const HealthReportUncheckedUpdateManyWithoutCurrentDietInputSchema: z.ZodType<Prisma.HealthReportUncheckedUpdateManyWithoutCurrentDietInput> = z.object({
...
export default HealthReportUncheckedUpdateManyWithoutCurrentDietInputSchema;
