...
export const MdxNoteCreateWithoutToDoInputSchema: z.ZodType<Prisma.MdxNoteCreateWithoutToDoInput> = z.object({
...
export default MdxNoteCreateWithoutToDoInputSchema;
