...
export const HealthReportMinOrderByAggregateInputSchema: z.ZodType<Prisma.HealthReportMinOrderByAggregateInput> = z.object({
...
export default HealthReportMinOrderByAggregateInputSchema;
