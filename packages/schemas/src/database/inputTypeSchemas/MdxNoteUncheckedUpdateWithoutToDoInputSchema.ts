...
export const MdxNoteUncheckedUpdateWithoutToDoInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateWithoutToDoInput> = z.object({
...
export default MdxNoteUncheckedUpdateWithoutToDoInputSchema;
