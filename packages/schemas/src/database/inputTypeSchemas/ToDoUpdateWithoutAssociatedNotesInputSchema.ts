...
export const ToDoUpdateWithoutAssociatedNotesInputSchema: z.ZodType<Prisma.ToDoUpdateWithoutAssociatedNotesInput> = z.object({
...
export default ToDoUpdateWithoutAssociatedNotesInputSchema;
