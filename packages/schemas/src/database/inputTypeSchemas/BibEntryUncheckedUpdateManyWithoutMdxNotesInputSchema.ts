...
export const BibEntryUncheckedUpdateManyWithoutMdxNotesInputSchema: z.ZodType<Prisma.BibEntryUncheckedUpdateManyWithoutMdxNotesInput> = z.object({
...
export default BibEntryUncheckedUpdateManyWithoutMdxNotesInputSchema;
