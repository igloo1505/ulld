...
export const MdxNoteUpdateWithoutEquationsInputSchema: z.ZodType<Prisma.MdxNoteUpdateWithoutEquationsInput> = z.object({
...
export default MdxNoteUpdateWithoutEquationsInputSchema;
