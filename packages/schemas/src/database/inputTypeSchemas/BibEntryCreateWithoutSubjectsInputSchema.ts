...
export const BibEntryCreateWithoutSubjectsInputSchema: z.ZodType<Prisma.BibEntryCreateWithoutSubjectsInput> = z.object({
  id: z.string(),
...
export default BibEntryCreateWithoutSubjectsInputSchema;
