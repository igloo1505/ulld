...
export const BibEntryUpdateManyWithoutTopicsNestedInputSchema: z.ZodType<Prisma.BibEntryUpdateManyWithoutTopicsNestedInput> = z.object({
...
export default BibEntryUpdateManyWithoutTopicsNestedInputSchema;
