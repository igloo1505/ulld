...
export const TagUpdateManyWithoutToDoNestedInputSchema: z.ZodType<Prisma.TagUpdateManyWithoutToDoNestedInput> = z.object({
...
export default TagUpdateManyWithoutToDoNestedInputSchema;
