...
export const ToDoCreateNestedManyWithoutTopicsInputSchema: z.ZodType<Prisma.ToDoCreateNestedManyWithoutTopicsInput> = z.object({
...
export default ToDoCreateNestedManyWithoutTopicsInputSchema;
