...
export const BibEntryUncheckedUpdateManyWithoutReadingListNestedInputSchema: z.ZodType<Prisma.BibEntryUncheckedUpdateManyWithoutReadingListNestedInput> = z.object({
...
export default BibEntryUncheckedUpdateManyWithoutReadingListNestedInputSchema;
