...
export const IpynbCreateWithoutSubjectsInputSchema: z.ZodType<Prisma.IpynbCreateWithoutSubjectsInput> = z.object({
...
export default IpynbCreateWithoutSubjectsInputSchema;
