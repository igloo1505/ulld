...
export const BibEntryUncheckedUpdateManyWithoutTopicsInputSchema: z.ZodType<Prisma.BibEntryUncheckedUpdateManyWithoutTopicsInput> = z.object({
...
export default BibEntryUncheckedUpdateManyWithoutTopicsInputSchema;
