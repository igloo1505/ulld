...
export const BibEntryUncheckedCreateWithoutSubjectsInputSchema: z.ZodType<Prisma.BibEntryUncheckedCreateWithoutSubjectsInput> = z.object({
  id: z.string(),
...
export default BibEntryUncheckedCreateWithoutSubjectsInputSchema;
