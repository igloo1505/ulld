...
export const TagCreateNestedManyWithoutTodoListInputSchema: z.ZodType<Prisma.TagCreateNestedManyWithoutTodoListInput> = z.object({
...
export default TagCreateNestedManyWithoutTodoListInputSchema;
