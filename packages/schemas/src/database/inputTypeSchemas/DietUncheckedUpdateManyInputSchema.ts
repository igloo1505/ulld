...
export const DietUncheckedUpdateManyInputSchema: z.ZodType<Prisma.DietUncheckedUpdateManyInput> = z.object({
...
export default DietUncheckedUpdateManyInputSchema;
