...
export const MdxNoteUncheckedUpdateWithoutSubjectsInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateWithoutSubjectsInput> = z.object({
...
export default MdxNoteUncheckedUpdateWithoutSubjectsInputSchema;
