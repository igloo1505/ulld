...
export const BibEntryUncheckedCreateWithoutTagsInputSchema: z.ZodType<Prisma.BibEntryUncheckedCreateWithoutTagsInput> = z.object({
  id: z.string(),
...
export default BibEntryUncheckedCreateWithoutTagsInputSchema;
