...
export const MdxNoteUncheckedUpdateManyWithoutTagsInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateManyWithoutTagsInput> = z.object({
...
export default MdxNoteUncheckedUpdateManyWithoutTagsInputSchema;
