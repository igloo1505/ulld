...
export const TopicUncheckedCreateWithoutEquationsInputSchema: z.ZodType<Prisma.TopicUncheckedCreateWithoutEquationsInput> = z.object({
  value: z.string(),
...
export default TopicUncheckedCreateWithoutEquationsInputSchema;
