...
export const IpynbUncheckedUpdateWithoutTagsInputSchema: z.ZodType<Prisma.IpynbUncheckedUpdateWithoutTagsInput> = z.object({
...
export default IpynbUncheckedUpdateWithoutTagsInputSchema;
