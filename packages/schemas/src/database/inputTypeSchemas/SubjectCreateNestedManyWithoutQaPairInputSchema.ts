...
export const SubjectCreateNestedManyWithoutQaPairInputSchema: z.ZodType<Prisma.SubjectCreateNestedManyWithoutQaPairInput> = z.object({
...
export default SubjectCreateNestedManyWithoutQaPairInputSchema;
