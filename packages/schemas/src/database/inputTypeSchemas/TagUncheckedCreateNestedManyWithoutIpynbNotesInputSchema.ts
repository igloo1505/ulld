...
export const TagUncheckedCreateNestedManyWithoutIpynbNotesInputSchema: z.ZodType<Prisma.TagUncheckedCreateNestedManyWithoutIpynbNotesInput> = z.object({
...
export default TagUncheckedCreateNestedManyWithoutIpynbNotesInputSchema;
