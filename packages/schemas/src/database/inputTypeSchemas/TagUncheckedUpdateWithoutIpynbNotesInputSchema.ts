...
export const TagUncheckedUpdateWithoutIpynbNotesInputSchema: z.ZodType<Prisma.TagUncheckedUpdateWithoutIpynbNotesInput> = z.object({
...
export default TagUncheckedUpdateWithoutIpynbNotesInputSchema;
