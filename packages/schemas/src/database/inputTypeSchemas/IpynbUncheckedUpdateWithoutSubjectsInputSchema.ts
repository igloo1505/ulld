...
export const IpynbUncheckedUpdateWithoutSubjectsInputSchema: z.ZodType<Prisma.IpynbUncheckedUpdateWithoutSubjectsInput> = z.object({
...
export default IpynbUncheckedUpdateWithoutSubjectsInputSchema;
