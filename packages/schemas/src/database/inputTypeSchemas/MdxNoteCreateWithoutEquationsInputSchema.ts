...
export const MdxNoteCreateWithoutEquationsInputSchema: z.ZodType<Prisma.MdxNoteCreateWithoutEquationsInput> = z.object({
...
export default MdxNoteCreateWithoutEquationsInputSchema;
