...
export const TopicUncheckedCreateNestedManyWithoutPracticeExamInputSchema: z.ZodType<Prisma.TopicUncheckedCreateNestedManyWithoutPracticeExamInput> = z.object({
...
export default TopicUncheckedCreateNestedManyWithoutPracticeExamInputSchema;
