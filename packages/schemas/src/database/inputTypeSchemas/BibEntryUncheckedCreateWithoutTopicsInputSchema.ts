...
export const BibEntryUncheckedCreateWithoutTopicsInputSchema: z.ZodType<Prisma.BibEntryUncheckedCreateWithoutTopicsInput> = z.object({
  id: z.string(),
...
export default BibEntryUncheckedCreateWithoutTopicsInputSchema;
