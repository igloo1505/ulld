...
export const BibEntryUpdateWithoutIpynbNotesInputSchema: z.ZodType<Prisma.BibEntryUpdateWithoutIpynbNotesInput> = z.object({
...
export default BibEntryUpdateWithoutIpynbNotesInputSchema;
