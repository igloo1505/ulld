...
export const HealthReportUncheckedUpdateManyInputSchema: z.ZodType<Prisma.HealthReportUncheckedUpdateManyInput> = z.object({
...
export default HealthReportUncheckedUpdateManyInputSchema;
