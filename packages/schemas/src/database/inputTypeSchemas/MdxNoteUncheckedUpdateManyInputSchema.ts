...
export const MdxNoteUncheckedUpdateManyInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateManyInput> = z.object({
...
export default MdxNoteUncheckedUpdateManyInputSchema;
