...
export const HealthReportUncheckedCreateNestedManyWithoutCurrentDietInputSchema: z.ZodType<Prisma.HealthReportUncheckedCreateNestedManyWithoutCurrentDietInput> = z.object({
