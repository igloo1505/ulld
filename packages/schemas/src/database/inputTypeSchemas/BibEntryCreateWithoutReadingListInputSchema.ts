...
export const BibEntryCreateWithoutReadingListInputSchema: z.ZodType<Prisma.BibEntryCreateWithoutReadingListInput> = z.object({
  id: z.string(),
...
export default BibEntryCreateWithoutReadingListInputSchema;
