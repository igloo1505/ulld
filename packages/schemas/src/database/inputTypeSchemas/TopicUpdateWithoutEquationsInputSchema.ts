...
export const TopicUpdateWithoutEquationsInputSchema: z.ZodType<Prisma.TopicUpdateWithoutEquationsInput> = z.object({
...
export default TopicUpdateWithoutEquationsInputSchema;
