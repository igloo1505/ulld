...
export const HealthReportSumOrderByAggregateInputSchema: z.ZodType<Prisma.HealthReportSumOrderByAggregateInput> = z.object({
...
export default HealthReportSumOrderByAggregateInputSchema;
