...
export const BibEntryUncheckedCreateNestedManyWithoutBibInputSchema: z.ZodType<Prisma.BibEntryUncheckedCreateNestedManyWithoutBibInput> = z.object({
...
export default BibEntryUncheckedCreateNestedManyWithoutBibInputSchema;
