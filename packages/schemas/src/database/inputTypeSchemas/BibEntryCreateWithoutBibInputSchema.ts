...
export const BibEntryCreateWithoutBibInputSchema: z.ZodType<Prisma.BibEntryCreateWithoutBibInput> = z.object({
  id: z.string(),
...
export default BibEntryCreateWithoutBibInputSchema;
