...
export const ToDoUpdateWithoutSubjectsInputSchema: z.ZodType<Prisma.ToDoUpdateWithoutSubjectsInput> = z.object({
...
export default ToDoUpdateWithoutSubjectsInputSchema;
