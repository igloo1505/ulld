...
export const IpynbUncheckedCreateNestedManyWithoutReadingListInputSchema: z.ZodType<Prisma.IpynbUncheckedCreateNestedManyWithoutReadingListInput> = z.object({
...
export default IpynbUncheckedCreateNestedManyWithoutReadingListInputSchema;
