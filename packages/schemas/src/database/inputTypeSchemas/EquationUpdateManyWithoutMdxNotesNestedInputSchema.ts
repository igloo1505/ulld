...
export const EquationUpdateManyWithoutMdxNotesNestedInputSchema: z.ZodType<Prisma.EquationUpdateManyWithoutMdxNotesNestedInput> = z.object({
...
export default EquationUpdateManyWithoutMdxNotesNestedInputSchema;
