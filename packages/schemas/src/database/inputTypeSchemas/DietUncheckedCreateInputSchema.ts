...
import { DietaryItemUncheckedCreateNestedManyWithoutDietInputSchema } from '../DietaryItemUncheckedCreateNestedManyWithoutDietInputSchema.js';
...
export const DietUncheckedCreateInputSchema: z.ZodType<Prisma.DietUncheckedCreateInput> = z.object({
  name: z.string(),
...
export default DietUncheckedCreateInputSchema;