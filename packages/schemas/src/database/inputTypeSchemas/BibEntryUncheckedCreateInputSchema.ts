...
export const BibEntryUncheckedCreateInputSchema: z.ZodType<Prisma.BibEntryUncheckedCreateInput> = z.object({
  id: z.string(),
...
export default BibEntryUncheckedCreateInputSchema;
