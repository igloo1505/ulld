...
export const BibEntryUncheckedUpdateManyWithoutReadingListInputSchema: z.ZodType<Prisma.BibEntryUncheckedUpdateManyWithoutReadingListInput> = z.object({
...
export default BibEntryUncheckedUpdateManyWithoutReadingListInputSchema;
