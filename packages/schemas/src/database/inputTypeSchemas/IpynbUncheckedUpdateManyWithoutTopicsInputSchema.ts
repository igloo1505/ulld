...
export const IpynbUncheckedUpdateManyWithoutTopicsInputSchema: z.ZodType<Prisma.IpynbUncheckedUpdateManyWithoutTopicsInput> = z.object({
...
export default IpynbUncheckedUpdateManyWithoutTopicsInputSchema;
