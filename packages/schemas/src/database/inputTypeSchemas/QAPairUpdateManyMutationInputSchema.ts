...
export const QAPairUpdateManyMutationInputSchema: z.ZodType<Prisma.QAPairUpdateManyMutationInput> = z.object({
...
export default QAPairUpdateManyMutationInputSchema;
