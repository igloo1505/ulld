...
export const EquationUncheckedCreateWithoutTagsInputSchema: z.ZodType<Prisma.EquationUncheckedCreateWithoutTagsInput> = z.object({
...
export default EquationUncheckedCreateWithoutTagsInputSchema;
