...
export const DefinitionUncheckedUpdateInputSchema: z.ZodType<Prisma.DefinitionUncheckedUpdateInput> = z.object({
...
export default DefinitionUncheckedUpdateInputSchema;
