...
export const BibEntryUncheckedUpdateWithoutIpynbNotesInputSchema: z.ZodType<Prisma.BibEntryUncheckedUpdateWithoutIpynbNotesInput> = z.object({
...
export default BibEntryUncheckedUpdateWithoutIpynbNotesInputSchema;