...
export const ToDoUncheckedUpdateManyWithoutToDoListInputSchema: z.ZodType<Prisma.ToDoUncheckedUpdateManyWithoutToDoListInput> = z.object({
...
export default ToDoUncheckedUpdateManyWithoutToDoListInputSchema;
