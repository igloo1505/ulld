...
export const DietaryItemFindFirstOrThrowArgsSchema: z.ZodType<Prisma.DietaryItemFindFirstOrThrowArgs> = z.object({
...
export default DietaryItemFindFirstOrThrowArgsSchema;
