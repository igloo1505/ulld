...
export const PracticeExamFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.PracticeExamFindUniqueOrThrowArgs> = z.object({
...
export default PracticeExamFindUniqueOrThrowArgsSchema;
