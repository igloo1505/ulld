...
export const ReadingListFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ReadingListFindUniqueOrThrowArgs> = z.object({
  select: ReadingListSelectSchema.optional(),
  include: ReadingListIncludeSchema.optional(),
  where: ReadingListWhereUniqueInputSchema,
}).strict() ;

export default ReadingListFindUniqueOrThrowArgsSchema;
