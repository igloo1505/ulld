...
export const EquationFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.EquationFindUniqueOrThrowArgs> = z.object({
  select: EquationSelectSchema.optional(),
  include: EquationIncludeSchema.optional(),
  where: EquationWhereUniqueInputSchema,
}).strict() ;

export default EquationFindUniqueOrThrowArgsSchema;
