...
export const SettingsAppendixFindFirstOrThrowArgsSchema: z.ZodType<Prisma.SettingsAppendixFindFirstOrThrowArgs> = z.object({
...
export default SettingsAppendixFindFirstOrThrowArgsSchema;
