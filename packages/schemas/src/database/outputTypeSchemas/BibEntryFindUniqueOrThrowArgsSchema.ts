...
export const BibEntryFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.BibEntryFindUniqueOrThrowArgs> = z.object({
  select: BibEntrySelectSchema.optional(),
  include: BibEntryIncludeSchema.optional(),
  where: BibEntryWhereUniqueInputSchema,
}).strict() ;

export default BibEntryFindUniqueOrThrowArgsSchema;
