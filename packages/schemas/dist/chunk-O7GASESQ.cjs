...
var ToDoSchema = _zod.z.object({
  category: _chunkPALRL6S5cjs.TaskCategorySchema.nullable(),
  id: _zod.z.number().int(),
  createdAt: _zod.z.coerce.date(),
  task: _zod.z.string(),
...
var RelatedValuesSchema = _zod.z.object({
  id: _zod.z.number().int(),
  input: _chunkATQO6OGEcjs.JsonValueSchema,
...
var EquationSchema = _zod.z.object({
  ...
  variableLegend: _chunkATQO6OGEcjs.JsonValueSchema,
...
//# sourceMappingURL=chunk-O7GASESQ.cjs.map