...
var SubjectCreateArgsSchema = _zod.z.object({
  ...
  data: _zod.z.union([_chunkPY3SNVJFcjs.SubjectCreateInputSchema, _chunkC6VRGJH7cjs.SubjectUncheckedCreateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-36G7N4TR.cjs.map