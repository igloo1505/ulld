...
var BibEntryUncheckedUpdateWithoutCitationGroupsInputSchema = _zod.z.object({
  ...
  BibId: _zod.z.union([_zod.z.number().int(), _zod.z.lazy(() => _chunkLDZNGXK5cjs.NullableIntFieldUpdateOperationsInputSchema)]).optional().nullable(),
  ...
  tags: _zod.z.lazy(() => _chunkF67HEIG4cjs.TagUncheckedUpdateManyWithoutBibEntriesNestedInputSchema).optional(),
  topics: _zod.z.lazy(() => _chunkF67HEIG4cjs.TopicUncheckedUpdateManyWithoutBibEntriesNestedInputSchema).optional(),
  subjects: _zod.z.lazy(() => _chunkF67HEIG4cjs.SubjectUncheckedUpdateManyWithoutBibEntriesNestedInputSchema).optional(),
  MdxNotes: _zod.z.lazy(() => _chunkF67HEIG4cjs.MdxNoteUncheckedUpdateManyWithoutCitationsNestedInputSchema).optional(),
  ipynbNotes: _zod.z.lazy(() => _chunkF67HEIG4cjs.IpynbUncheckedUpdateManyWithoutCitationsNestedInputSchema).optional(),
  readingList: _zod.z.lazy(() => _chunkF67HEIG4cjs.ReadingListUncheckedUpdateManyWithoutBibEntriesNestedInputSchema).optional()
}).strict();
...
//# sourceMappingURL=chunk-VMTVDIZS.cjs.map