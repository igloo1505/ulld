...
var BibEntryCreateArgsSchema = _zod.z.object({
  ...
  data: _zod.z.union([_chunkBQKO6WEKcjs.BibEntryCreateInputSchema, _chunkIQWWZMNJcjs.BibEntryUncheckedCreateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-WI2432IY.cjs.map