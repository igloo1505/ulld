...
// src/database/outputTypeSchemas/BibEntryCreateArgsSchema.ts
...
var BibEntryCreateArgsSchema = _zod.z.object({
  select: BibEntrySelectSchema.optional(),
  include: _chunk2MYBOFS7cjs.BibEntryIncludeSchema.optional(),
  data: _zod.z.union([_chunkUKMVFMG3cjs.BibEntryCreateInputSchema, _chunk25PREG26cjs.BibEntryUncheckedCreateInputSchema])
}).strict();
var BibEntryCreateArgsSchema_default = BibEntryCreateArgsSchema;





exports.BibEntrySelectSchema = BibEntrySelectSchema; exports.BibEntryCreateArgsSchema = BibEntryCreateArgsSchema; exports.BibEntryCreateArgsSchema_default = BibEntryCreateArgsSchema_default;
//# sourceMappingURL=chunk-5BA67VEU.cjs.map