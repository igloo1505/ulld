...
var mdxNoteFromStringPropsSchema = _chunk4ZSFJZFZcjs.mdxNotePropsSchema.pick({
  ...
  _zod.z.object({
    docTypeData: _documentConfigSchema.documentTypeConfigSchemaOutputSchema
  })
);
var unifiedMdxParserSchema = _zod.z.function().args(_chunk5TAHGLA6cjs.unifiedMdxParserParamSchema).returns(_zod.z.promise(_chunkE2INLS7Kcjs.extendedFrontMatterSchema));
...
var parseParamsSchema = _zod.z.object({
  ...
  docTypeData: _zod.z.union([_documentConfigSchema.documentTypeConfigSchemaOutputSchema, _zod.z.object({})]).default({}),
...
//# sourceMappingURL=chunk-TRTLENER.cjs.map