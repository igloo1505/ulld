...
var DietSchema = _zod.z.object({
  gf: _chunkLQQKOQFTcjs.TERTIARY_TOGGLESchema,
  fasting: _chunkLQQKOQFTcjs.TERTIARY_TOGGLESchema,
  cardioTraining: _chunkLQQKOQFTcjs.TERTIARY_TOGGLESchema,
  weightTraining: _chunkLQQKOQFTcjs.TERTIARY_TOGGLESchema,
  goals: _chunkR2GMKW2Wcjs.DIETARY_GOALSchema.array(),
  name: _zod.z.string(),
  summary: _zod.z.string().nullable(),
...
var ServingSchema = _zod.z.object({
  quant_guess: _chunk2HKOVXYCcjs.QUANTITY_GUESSSchema.nullable(),
  id: _zod.z.number().int(),
...
//# sourceMappingURL=chunk-7B3QXWWJ.cjs.map