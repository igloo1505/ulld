...
var HealthReportUpsertArgsSchema = _zod.z.object({
  ...
  create: _zod.z.union([_chunk6CLUJKIWcjs.HealthReportCreateInputSchema, _chunkOENNX65Ycjs.HealthReportUncheckedCreateInputSchema]),
  update: _zod.z.union([_chunk4GJXYHEUcjs.HealthReportUpdateInputSchema, _chunkMVUTCT6Fcjs.HealthReportUncheckedUpdateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-QWFN3EDV.cjs.map