...
var MdxNoteUpdateInputSchema = _zod.z.object({
  ...
  topics: _zod.z.lazy(() => _chunkF67HEIG4cjs.TopicUpdateManyWithoutMdxNotesNestedInputSchema).optional(),
  subjects: _zod.z.lazy(() => _chunkF67HEIG4cjs.SubjectUpdateManyWithoutMdxNotesNestedInputSchema).optional(),
  tags: _zod.z.lazy(() => _chunkF67HEIG4cjs.TagUpdateManyWithoutMdxNotesNestedInputSchema).optional(),
  citations: _zod.z.lazy(() => _chunkF67HEIG4cjs.BibEntryUpdateManyWithoutMdxNotesNestedInputSchema).optional(),
  sequentialList: _zod.z.lazy(() => _chunkF67HEIG4cjs.SequentialNoteListUpdateOneWithoutMdxNoteNestedInputSchema).optional(),
  ReadingList: _zod.z.lazy(() => _chunkF67HEIG4cjs.ReadingListUpdateManyWithoutMdxNotesNestedInputSchema).optional(),
  equations: _zod.z.lazy(() => _chunkF67HEIG4cjs.EquationUpdateManyWithoutMdxNotesNestedInputSchema).optional(),
  definitions: _zod.z.lazy(() => _chunkUW4DQXG4cjs.DefinitionUpdateManyWithoutMdxNoteNestedInputSchema).optional(),
  toDo: _zod.z.lazy(() => _chunkF67HEIG4cjs.ToDoUpdateManyWithoutAssociatedNotesNestedInputSchema).optional()
}).strict();
...
exports.MdxNoteUpdateInputSchema = MdxNoteUpdateInputSchema; exports.MdxNoteUpdateInputSchema_default = MdxNoteUpdateInputSchema_default;
//# sourceMappingURL=chunk-SE3F2SOH.cjs.map