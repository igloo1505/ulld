...
var IpynbUpdateInputSchema = _zod.z.object({
  ...
  tags: _zod.z.lazy(() => _chunkF67HEIG4cjs.TagUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  topics: _zod.z.lazy(() => _chunkF67HEIG4cjs.TopicUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  subjects: _zod.z.lazy(() => _chunkF67HEIG4cjs.SubjectUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  citations: _zod.z.lazy(() => _chunkF67HEIG4cjs.BibEntryUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  sequentialList: _zod.z.lazy(() => _chunkF67HEIG4cjs.SequentialNoteListUpdateOneWithoutIpynbNestedInputSchema).optional(),
  readingList: _zod.z.lazy(() => _chunkF67HEIG4cjs.ReadingListUpdateManyWithoutIpynbNotesNestedInputSchema).optional()
}).strict();
...
//# sourceMappingURL=chunk-YWRLFL7S.cjs.map