...
var MdxNoteCreateArgsSchema = _zod.z.object({
  ...
  data: _zod.z.union([_chunkAWD5GEKNcjs.MdxNoteCreateInputSchema, _chunk2ZR46RTWcjs.MdxNoteUncheckedCreateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-GKJMMJST.cjs.map