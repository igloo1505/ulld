...
var HealthReportUpdateManyWithoutCurrentDietNestedInputSchema = _zod.z.object({
  ...
  upsert: _zod.z.union([_zod.z.lazy(() => _chunkZ6FXW23Dcjs.HealthReportUpsertWithWhereUniqueWithoutCurrentDietInputSchema), _zod.z.lazy(() => _chunkZ6FXW23Dcjs.HealthReportUpsertWithWhereUniqueWithoutCurrentDietInputSchema).array()]).optional(),
  createMany: _zod.z.lazy(() => _chunkV2ZIZVXEcjs.HealthReportCreateManyCurrentDietInputEnvelopeSchema).optional(),
  set: _zod.z.union([_zod.z.lazy(() => _chunk3ZQVKIXXcjs.HealthReportWhereUniqueInputSchema), _zod.z.lazy(() => _chunk3ZQVKIXXcjs.HealthReportWhereUniqueInputSchema).array()]).optional(),
  disconnect: _zod.z.union([_zod.z.lazy(() => _chunk3ZQVKIXXcjs.HealthReportWhereUniqueInputSchema), _zod.z.lazy(() => _chunk3ZQVKIXXcjs.HealthReportWhereUniqueInputSchema).array()]).optional(),
  delete: _zod.z.union([_zod.z.lazy(() => _chunk3ZQVKIXXcjs.HealthReportWhereUniqueInputSchema), _zod.z.lazy(() => _chunk3ZQVKIXXcjs.HealthReportWhereUniqueInputSchema).array()]).optional(),
  ...
  update: _zod.z.union([_zod.z.lazy(() => _chunkYDIGLIJUcjs.HealthReportUpdateWithWhereUniqueWithoutCurrentDietInputSchema), _zod.z.lazy(() => _chunkYDIGLIJUcjs.HealthReportUpdateWithWhereUniqueWithoutCurrentDietInputSchema).array()]).optional(),
  updateMany: _zod.z.union([_zod.z.lazy(() => _chunkOUOLYUSKcjs.HealthReportUpdateManyWithWhereWithoutCurrentDietInputSchema), _zod.z.lazy(() => _chunkOUOLYUSKcjs.HealthReportUpdateManyWithWhereWithoutCurrentDietInputSchema).array()]).optional(),
  deleteMany: _zod.z.union([_zod.z.lazy(() => _chunkDBOMRJJCcjs.HealthReportScalarWhereInputSchema), _zod.z.lazy(() => _chunkDBOMRJJCcjs.HealthReportScalarWhereInputSchema).array()]).optional()
}).strict();
...
//# sourceMappingURL=chunk-4ODMRDMR.cjs.map