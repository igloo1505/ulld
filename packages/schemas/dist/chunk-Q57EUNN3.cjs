...
// src/database/outputTypeSchemas/BibEntryUpsertArgsSchema.ts
...
var BibEntryUpsertArgsSchema = _zod.z.object({
  select: BibEntrySelectSchema.optional(),
  include: _chunk2MYBOFS7cjs.BibEntryIncludeSchema.optional(),
  where: _chunkHYOFN6RRcjs.BibEntryWhereUniqueInputSchema,
  create: _zod.z.union([_chunkUKMVFMG3cjs.BibEntryCreateInputSchema, _chunk25PREG26cjs.BibEntryUncheckedCreateInputSchema]),
  update: _zod.z.union([_chunk6QVRB4LScjs.BibEntryUpdateInputSchema, _chunk7DFAKDR5cjs.BibEntryUncheckedUpdateInputSchema])
}).strict();
var BibEntryUpsertArgsSchema_default = BibEntryUpsertArgsSchema;





exports.BibEntrySelectSchema = BibEntrySelectSchema; exports.BibEntryUpsertArgsSchema = BibEntryUpsertArgsSchema; exports.BibEntryUpsertArgsSchema_default = BibEntryUpsertArgsSchema_default;
//# sourceMappingURL=chunk-Q57EUNN3.cjs.map