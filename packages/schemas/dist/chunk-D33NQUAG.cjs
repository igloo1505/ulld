...
// src/database/inputTypeSchemas/DietUpdateWithoutItemsInputSchema.ts
var _zod = require('zod');
var DietUpdateWithoutItemsInputSchema = _zod.z.object({
  ...
  HealthReport: _zod.z.lazy(() => _chunkCH5ULX7Gcjs.HealthReportUpdateManyWithoutCurrentDietNestedInputSchema).optional()
}).strict();
var DietUpdateWithoutItemsInputSchema_default = DietUpdateWithoutItemsInputSchema;




exports.DietUpdateWithoutItemsInputSchema = DietUpdateWithoutItemsInputSchema; exports.DietUpdateWithoutItemsInputSchema_default = DietUpdateWithoutItemsInputSchema_default;
//# sourceMappingURL=chunk-D33NQUAG.cjs.map