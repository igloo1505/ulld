...
// src/database/inputTypeSchemas/BibEntryUncheckedCreateWithoutCitationGroupsInputSchema.ts
import { z } from "zod";
var BibEntryUncheckedCreateWithoutCitationGroupsInputSchema = z.object({
  id: z.string(),
  ...
  ipynbNotes: z.lazy(() => IpynbUncheckedCreateNestedManyWithoutCitationsInputSchema).optional(),
  readingList: z.lazy(() => ReadingListUncheckedCreateNestedManyWithoutBibEntriesInputSchema).optional()
}).strict();
var BibEntryUncheckedCreateWithoutCitationGroupsInputSchema_default = BibEntryUncheckedCreateWithoutCitationGroupsInputSchema;

export {
  BibEntryUncheckedCreateWithoutCitationGroupsInputSchema,
  BibEntryUncheckedCreateWithoutCitationGroupsInputSchema_default
};
//# sourceMappingURL=chunk-VNNUPIMN.js.map