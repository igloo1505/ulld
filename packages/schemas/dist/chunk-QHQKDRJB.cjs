...
var ReadingListUpsertArgsSchema = _zod.z.object({
  ...
  create: _zod.z.union([_chunkS2NO5WC6cjs.ReadingListCreateInputSchema, _chunkCUON643Hcjs.ReadingListUncheckedCreateInputSchema]),
  update: _zod.z.union([_chunkPSGRIDBUcjs.ReadingListUpdateInputSchema, _chunkZC65SMW7cjs.ReadingListUncheckedUpdateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-QHQKDRJB.cjs.map