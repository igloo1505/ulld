...
var EquationCreateArgsSchema = _zod.z.object({
  ...
  data: _zod.z.union([_chunkRKI5ZLL3cjs.EquationCreateInputSchema, _chunkZDTKZ3W3cjs.EquationUncheckedCreateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-SPDR6RNL.cjs.map