...
var ToDoListUpsertArgsSchema = _zod.z.object({
  ...
  create: _zod.z.union([_chunkBQT5D4EXcjs.ToDoListCreateInputSchema, _chunk5XYVDMEOcjs.ToDoListUncheckedCreateInputSchema]),
  update: _zod.z.union([_chunkFXNE6KAVcjs.ToDoListUpdateInputSchema, _chunkOOQHANQCcjs.ToDoListUncheckedUpdateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-CXRLGEQ4.cjs.map