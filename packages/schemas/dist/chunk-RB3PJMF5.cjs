...
var BibEntryUpsertArgsSchema = _zod.z.object({
  ...
  create: _zod.z.union([_chunkBQKO6WEKcjs.BibEntryCreateInputSchema, _chunkIQWWZMNJcjs.BibEntryUncheckedCreateInputSchema]),
  update: _zod.z.union([_chunkDZLOEJBDcjs.BibEntryUpdateInputSchema, _chunkQJLJWU65cjs.BibEntryUncheckedUpdateInputSchema])
}).strict();
...
//# sourceMappingURL=chunk-RB3PJMF5.cjs.map