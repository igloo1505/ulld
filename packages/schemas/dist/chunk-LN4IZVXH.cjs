...
// src/database/inputTypeSchemas/HealthReportCountOrderByAggregateInputSchema.ts
var _zod = require('zod');
var HealthReportCountOrderByAggregateInputSchema = _zod.z.object({
  ...
  weight: _zod.z.lazy(() => _chunk75IWYFYUcjs.SortOrderSchema).optional(),
  ...
  anxiety_desc: _zod.z.lazy(() => _chunk75IWYFYUcjs.SortOrderSchema).optional(),
  mood_desc: _zod.z.lazy(() => _chunk75IWYFYUcjs.SortOrderSchema).optional(),
  ...
  sleepHours: _zod.z.lazy(() => _chunk75IWYFYUcjs.SortOrderSchema).optional(),
  calorie_est: _zod.z.lazy(() => _chunk75IWYFYUcjs.SortOrderSchema).optional(),
  times_meals_more_than_gap_apart: _zod.z.lazy(() => _chunk75IWYFYUcjs.SortOrderSchema).optional(),
  estHoursInExcessFast: _zod.z.lazy(() => _chunk75IWYFYUcjs.SortOrderSchema).optional(),
...
var HealthReportCountOrderByAggregateInputSchema_default = HealthReportCountOrderByAggregateInputSchema;




exports.HealthReportCountOrderByAggregateInputSchema = HealthReportCountOrderByAggregateInputSchema; exports.HealthReportCountOrderByAggregateInputSchema_default = HealthReportCountOrderByAggregateInputSchema_default;
//# sourceMappingURL=chunk-LN4IZVXH.cjs.map