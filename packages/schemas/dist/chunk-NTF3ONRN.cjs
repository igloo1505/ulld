...
var IpynbUncheckedUpdateInputSchema = _zod.z.object({
  ...
  tags: _zod.z.lazy(() => _chunk642YCHOVcjs.TagUncheckedUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  topics: _zod.z.lazy(() => _chunk642YCHOVcjs.TopicUncheckedUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  subjects: _zod.z.lazy(() => _chunk642YCHOVcjs.SubjectUncheckedUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  citations: _zod.z.lazy(() => _chunk642YCHOVcjs.BibEntryUncheckedUpdateManyWithoutIpynbNotesNestedInputSchema).optional(),
  readingList: _zod.z.lazy(() => _chunk642YCHOVcjs.ReadingListUncheckedUpdateManyWithoutIpynbNotesNestedInputSchema).optional()
}).strict();
...
//# sourceMappingURL=chunk-NTF3ONRN.cjs.map