...
var DietCreateArgsSchema = _zod.z.object({
  select: DietSelectSchema.optional(),
  include: _chunkN2ITDNOTcjs.DietIncludeSchema.optional(),
  data: _zod.z.union([_chunkQCIC7UPZcjs.DietCreateInputSchema, _chunkC4NY6BIDcjs.DietUncheckedCreateInputSchema])
}).strict();
...
exports.DietSelectSchema = DietSelectSchema; exports.DietCreateArgsSchema = DietCreateArgsSchema; exports.DietCreateArgsSchema_default = DietCreateArgsSchema_default;
//# sourceMappingURL=chunk-N7S4OD34.cjs.map