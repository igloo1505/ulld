...
var _chunkL4SEUS5Gcjs = require('./chunk-L4SEUS5G.cjs');
...
var docTypeUISchema = _zod.z.object({
...
var documentTypeConfigSchemaFields = {
  ...
  matchWeight: _zod.z.number().min(0).max(100).default(50).describe(
  ...
  urlQuery: _zod.z.record(_zod.z.string(), parsableSearchParam).optional().describe(
  ...
  icon: _chunkL4SEUS5Gcjs.iconNameField.default("ulld"),
  inSidebar: _zod.z.boolean().default(false),
  inNavbar: _zod.z.boolean().default(false)
};
var documentTypeConfigSchemaBase = _zod.z.object(documentTypeConfigSchemaFields);
...
exports.docTypeUISchema = docTypeUISchema; exports.zodDocTypeInput = zodDocTypeInput; exports.documentTypeConfigSchemaBase = documentTypeConfigSchemaBase; exports.documentTypeConfigSchemaInner = documentTypeConfigSchemaInner; exports.documentTypeConfigSchema = documentTypeConfigSchema;
//# sourceMappingURL=chunk-CIWR5AEH.cjs.map