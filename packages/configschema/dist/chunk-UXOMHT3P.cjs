...
var databaseConfigSchemaOutput = _zod.z.object({
  storeFormatted: _zod.z.boolean(),
  removeIfNotPresentInFs: _zod.z.boolean()
});




exports.databaseConfigSchema = databaseConfigSchema; exports.databaseConfigSchemaOutput = databaseConfigSchemaOutput;
//# sourceMappingURL=chunk-UXOMHT3P.cjs.map