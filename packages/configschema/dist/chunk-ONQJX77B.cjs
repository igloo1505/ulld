...
var documentTypeConfigSchemaBase = _zod.z.object({
  ...
  url: _zod.z.string().describe("The url at which this note should be displayed.").transform(_chunk5DEJBS5Ycjs.zodWithForwardSlashTransform),
  ...
  icon: _chunkXYNU2XEWcjs.iconNameField.default("ulld"),
...
//# sourceMappingURL=chunk-ONQJX77B.cjs.map