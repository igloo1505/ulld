...
var componentConfigSchema = z.object({
  ...
  embeddable: z.union([embeddableConfigSchema.array(), embeddableConfigSchema]).optional().transform(
  ...
  docsExport: z.string().optional().describe(
  ...
  fullDocsExport: z.string().optional().describe(
...
//# sourceMappingURL=chunk-JX2ADNSR.mjs.map