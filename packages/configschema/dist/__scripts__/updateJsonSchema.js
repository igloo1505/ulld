...
var configJsonSchema = zodToJsonSchema(appConfigSchema, "ULLDConfig");
fs.writeFileSync(path.join(import.meta.dirname || __dirname, "../../../developer-schemas/src/static/ulldConfig.json"), JSON.stringify(configJsonSchema, null, 4));
fs.writeFileSync("/Users/bigsexy/dev-utils/jsonSchemas/src/schemas/json/ulldConfig.json", JSON.stringify(configJsonSchema, null, 4));
//# sourceMappingURL=updateJsonSchema.js.map