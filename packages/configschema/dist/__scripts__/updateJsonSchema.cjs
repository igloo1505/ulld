...
var configJsonSchema = zodToJsonSchema.zodToJsonSchema(appConfigSchema, "ULLDConfig");
fs__default.default.writeFileSync(path__default.default.join(undefined || __dirname, "../../../developer-schemas/src/static/ulldConfig.json"), JSON.stringify(configJsonSchema, null, 4));
fs__default.default.writeFileSync("/Users/bigsexy/dev-utils/jsonSchemas/src/schemas/json/ulldConfig.json", JSON.stringify(configJsonSchema, null, 4));
