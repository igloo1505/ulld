...
var colorValueOutput = _zod.z.object({
  dark: _zod.z.string(),
  light: _zod.z.string()
});
...
var colorConfigSchemaInner = _zod.z.record(_zod.z.string(), colorValue);
var colorsConfigSchema = colorConfigSchemaInner.default(_chunkMZET64JIcjs.defaultUlldColorMap);
var colorConfigSchemaOutput = _zod.z.record(_zod.z.string(), colorValueOutput);
...
exports.colorGroup = colorGroup; exports.colorValueOutput = colorValueOutput; exports.colorsConfigSchema = colorsConfigSchema; exports.colorConfigSchemaOutput = colorConfigSchemaOutput;
//# sourceMappingURL=chunk-6WYSQD2O.cjs.map