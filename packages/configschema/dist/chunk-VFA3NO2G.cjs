...
var zodDocTypeInput = _zod.z.string().transform(_identity.makeValidIdOnlyLetters).brand("DocTypeName");
var documentTypeConfigSchemaBase = _zod.z.object({
  ...
  url: _zod.z.string().describe("The url at which this note should be displayed.").transform(_chunkGTFPLYO5cjs.zodWithForwardSlashTransform),
  ...
  icon: _chunk3ZQ4RWTPcjs.iconNameField.default("ulld"),
...
exports.docTypeUISchema = docTypeUISchema; exports.zodDocTypeInput = zodDocTypeInput; exports.documentTypeConfigSchemaBase = documentTypeConfigSchemaBase; exports.documentTypeConfigSchema = documentTypeConfigSchema;
//# sourceMappingURL=chunk-VFA3NO2G.cjs.map