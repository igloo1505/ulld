...
var _chunkXMYNCCKRcjs = require('../../chunk-XMYNCCKR.cjs');
require('../../chunk-YC67XZCL.cjs');
require('../../chunk-TWSZCXZB.cjs');
...
var configSecondaryParse = (initialParsedConfig) => {
  return _chunkXMYNCCKRcjs.secondaryConfigParse.parse(initialParsedConfig);
};
