...
var _chunkJUE4ILEJcjs = require('../../chunk-JUE4ILEJ.cjs');
require('../../chunk-5YN3525P.cjs');
...
var configSecondaryParse = (initialParsedConfig) => {
  return _chunkJUE4ILEJcjs.secondaryConfigParse.parse(initialParsedConfig);
};


exports.configSecondaryParse = configSecondaryParse;
//# sourceMappingURL=configSecondaryParse.cjs.map