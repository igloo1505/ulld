...
var internalDocTypes = zod.z.union([
...
exports.internalDocTypes = internalDocTypes;
exports.internalDocumentTypeConfigSchema = internalDocumentTypeConfigSchema;
exports.internalDocumentTypes = internalDocumentTypes;
