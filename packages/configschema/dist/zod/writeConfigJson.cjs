...
var writeConfigJson = async (config, targetDirectory) => {
  let parsed = _chunkCCXG2LLGcjs.appConfigSchema.parse(config);
  const jsonSchema = _zodtojsonschema.zodToJsonSchema.call(void 0, _chunkCCXG2LLGcjs.appConfigSchema, {
    name: "UlldAppConfig",
