...
var writeConfigJson = async (config, targetDirectory) => {
  let parsed = _chunk56GHHGNJcjs.appConfigSchema.parse(config);
  const jsonSchema = _zodtojsonschema.zodToJsonSchema.call(void 0, _chunk56GHHGNJcjs.appConfigSchema, {
    name: "UlldAppConfig",
