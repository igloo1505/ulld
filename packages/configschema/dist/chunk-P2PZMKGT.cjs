...
var additionalUserContentOutput = _zod.z.object({
  css: _zod.z.string().optional(),
  favicon: _zod.z.string().optional(),
...
exports.additionalUserContent = additionalUserContent; exports.additionalUserContentOutput = additionalUserContentOutput;
//# sourceMappingURL=chunk-P2PZMKGT.cjs.map