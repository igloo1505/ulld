...
var _chunkU7NIGYYLcjs = require('./chunk-U7NIGYYL.cjs');


var _chunkO5G4CUM4cjs = require('./chunk-O5G4CUM4.cjs');


var _chunkFGDHIBSNcjs = require('./chunk-FGDHIBSN.cjs');
...
var appConfigSchema = _zod.z.object({
  ...
  ).default(_chunkM677MBJMcjs.defaultIgnoreFilePaths).transform(zodRegexFieldTransform).default([]),
  ...
  ).transform(_chunk5DEJBS5Ycjs.zodPathGlobTransform).array().default([]),
  ...
  noteTypes: _chunkONQJX77Bcjs.documentTypeConfigSchema.array().default(_chunkBMKGPO6Qcjs.defaultNoteTypes).transform((x) => {
    let ids = x.map((l) => l.id);
    let data = x;
    for (const defaultNoteType of _chunkBMKGPO6Qcjs.defaultNoteTypes) {
      if (!ids.includes(defaultNoteType.id)) {
        data.push(_chunkONQJX77Bcjs.documentTypeConfigSchema.parse(defaultNoteType));
      }
    }
    return data;
  }).describe(
  ...
  math: _chunkU7NIGYYLcjs.mathConfigSchema,
  plotting: _chunkSAAJV3BHcjs.plotConfigSchema,
  navigation: _chunkXYNU2XEWcjs.navigationConfigSchema,
  UI: _chunkFGDHIBSNcjs.mainUIConfigSchema,
  database: _chunk3VEE7NEQcjs.databaseConfigSchema,
  jupyter: _chunkO5G4CUM4cjs.jupyterConfigSchema.default({}),
  credentials: _chunk46A3VLREcjs.credentialsConfigSchema,
  performance: _chunkXV6PA66Ccjs.performanceConfigSchema,
  terminal: _chunkPXSYJX6Wcjs.terminalConfigSchema,
...
//# sourceMappingURL=chunk-6QZ5W3RP.cjs.map