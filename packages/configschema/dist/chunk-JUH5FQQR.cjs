...
var zodPathWithGlobField = (desc, optional) => desc ? optional ? _zod.z.union([_zod.z.string(), _zod.z.instanceof(RegExp)]).optional().describe(desc).transform((a) => a ? zodPathGlobTransform(a) : a) : _zod.z.union([_zod.z.string(), _zod.z.instanceof(RegExp)]).describe(desc).transform(zodPathGlobTransform) : optional ? _zod.z.union([_zod.z.string(), _zod.z.instanceof(RegExp)]).optional().transform((a) => a ? zodPathGlobTransform(a) : a) : _zod.z.union([_zod.z.string(), _zod.z.instanceof(RegExp)]).transform(zodPathGlobTransform);
...
//# sourceMappingURL=chunk-JUH5FQQR.cjs.map