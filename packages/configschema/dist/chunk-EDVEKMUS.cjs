...
var code_config_schema = _zod.z.object({
  theme: _zod.z.object({
    dark: _chunkCXDZSOSOcjs.shikiThemeValidator.default(defaultThemes.dark).describe(
      "Syntax highlighting theme to be used when in dark mode. Can be overriden with the ?shikiHlDark=dracula search param."
    ),
    light: _chunkCXDZSOSOcjs.shikiThemeValidator.default(defaultThemes.light).describe(
  ...
  editor: _chunkOFDQ7ET3cjs.monacoEditorConfigSchema,
...
//# sourceMappingURL=chunk-EDVEKMUS.cjs.map