...
var documentTypeConfigSchemaBase = _zod.z.object({
  ...
  icon: _chunkEEXWFUX2cjs.iconNameField.default("ulld"),
...
var documentTypeConfigSchemaOutputSchema = documentTypeConfigSchemaInner.merge(
  _zod.z.object({
    ...
    icon: _chunkEEXWFUX2cjs.iconNameField,
...
var documentTypeConfigMinimalOutputSchema = documentTypeConfigSchemaInner.deepPartial().merge(
  _zod.z.object({
    ...
    docType: _zod.z.string().optional(),
    matchWeight: matchWeightField.optional(),
    urlQuery: urlQueryField.optional(),
    url: _zod.z.string().optional(),
    keywords: _zod.z.string().array().optional(),
    autoTag: _zod.z.string().array().optional(),
    autoTopic: _zod.z.string().array().optional(),
    autoSubject: _zod.z.string().array().optional(),
    UI: docTypeUISchemaOutput.optional(),
    icon: _chunkEEXWFUX2cjs.iconNameField.optional(),
    inSidebar: _zod.z.boolean().optional(),
    inNavbar: _zod.z.boolean().optional(),
    fs: _zod.z.string()
  })
);
