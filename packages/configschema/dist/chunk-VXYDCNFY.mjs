...
var documentTypeConfigSchemaFields = {
  ...
  matchWeight: z.number().min(0).max(100).default(50).describe(
  ...
  urlQuery: z.record(z.string(), parsableSearchParam).optional().describe(
...
var documentTypeConfigSchemaBase = z.object(documentTypeConfigSchemaFields);
...
//# sourceMappingURL=chunk-VXYDCNFY.mjs.map