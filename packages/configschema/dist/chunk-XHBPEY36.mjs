...
var zodPathWithGlobField = (desc, optional) => desc ? optional ? z.union([z.string(), z.instanceof(RegExp)]).optional().describe(desc).transform((a) => a ? zodPathGlobTransform(a) : a) : z.union([z.string(), z.instanceof(RegExp)]).describe(desc).transform(zodPathGlobTransform) : optional ? z.union([z.string(), z.instanceof(RegExp)]).optional().transform((a) => a ? zodPathGlobTransform(a) : a) : z.union([z.string(), z.instanceof(RegExp)]).transform(zodPathGlobTransform);
...
//# sourceMappingURL=chunk-XHBPEY36.mjs.map