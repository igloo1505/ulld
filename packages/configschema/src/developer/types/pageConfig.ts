...
export type PluginPageConfig<T extends PluginSlotKey | undefined> =
    | (PluginPageConfigBase & WithUrl)
    | (PluginPageConfigBase & WithSlot<T>);
export type PluginPageConfigWithoutGeneric =
    | (PluginPageConfigBase & WithUrl)
    | (PluginPageConfigBase & WithSlotWithoutGeneric);
