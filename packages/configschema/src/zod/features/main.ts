...
// const featurePagesSchema = z.object({
...
// const _featuresConfigSchemaInner = z.object({
    // enabled: z.object({
...
// export const featuresConfigSchema = _featuresConfigSchemaInner.optional()


// export const featuresConfigSchemaOutput = _featuresConfigSchemaInner.merge(z.object({
//      pages: z.object
// }))
