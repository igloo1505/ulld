...
export const CitationsGroupFindUniqueArgsSchema: z.ZodType<Prisma.CitationsGroupFindUniqueArgs> = z.object({
...
export default CitationsGroupFindUniqueArgsSchema;
