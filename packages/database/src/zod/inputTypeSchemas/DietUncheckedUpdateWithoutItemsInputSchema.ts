...
import { HealthReportUncheckedUpdateManyWithoutCurrentDietNestedInputSchema } from './HealthReportUncheckedUpdateManyWithoutCurrentDietNestedInputSchema';

export const DietUncheckedUpdateWithoutItemsInputSchema: z.ZodType<Prisma.DietUncheckedUpdateWithoutItemsInput> = z.object({
...
export default DietUncheckedUpdateWithoutItemsInputSchema;
