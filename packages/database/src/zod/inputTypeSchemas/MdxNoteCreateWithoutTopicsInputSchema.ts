...
export const MdxNoteCreateWithoutTopicsInputSchema: z.ZodType<Prisma.MdxNoteCreateWithoutTopicsInput> = z.object({
...
export default MdxNoteCreateWithoutTopicsInputSchema;
