...
export const KanBanCardUncheckedUpdateInputSchema: z.ZodType<Prisma.KanBanCardUncheckedUpdateInput> = z.object({
...
export default KanBanCardUncheckedUpdateInputSchema;
