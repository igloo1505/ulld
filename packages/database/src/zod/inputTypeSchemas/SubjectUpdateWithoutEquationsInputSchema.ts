...
export const SubjectUpdateWithoutEquationsInputSchema: z.ZodType<Prisma.SubjectUpdateWithoutEquationsInput> = z.object({
...
export default SubjectUpdateWithoutEquationsInputSchema;
