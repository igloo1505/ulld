...
export const MdxNoteUncheckedUpdateWithoutTagsInputSchema: z.ZodType<Prisma.MdxNoteUncheckedUpdateWithoutTagsInput> = z.object({
...
export default MdxNoteUncheckedUpdateWithoutTagsInputSchema;
