...
export const DietaryItemUncheckedUpdateManyWithoutDietInputSchema: z.ZodType<Prisma.DietaryItemUncheckedUpdateManyWithoutDietInput> = z.object({
...
export default DietaryItemUncheckedUpdateManyWithoutDietInputSchema;
