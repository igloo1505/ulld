...
export const ToDoUncheckedCreateWithoutAssociatedNotesInputSchema: z.ZodType<Prisma.ToDoUncheckedCreateWithoutAssociatedNotesInput> = z.object({
...
export default ToDoUncheckedCreateWithoutAssociatedNotesInputSchema;
