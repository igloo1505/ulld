...
export const MdxNoteUpdateWithoutTagsInputSchema: z.ZodType<Prisma.MdxNoteUpdateWithoutTagsInput> = z.object({
...
export default MdxNoteUpdateWithoutTagsInputSchema;
