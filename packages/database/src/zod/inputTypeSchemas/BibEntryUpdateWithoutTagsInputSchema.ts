...
export const BibEntryUpdateWithoutTagsInputSchema: z.ZodType<Prisma.BibEntryUpdateWithoutTagsInput> = z.object({
...
export default BibEntryUpdateWithoutTagsInputSchema;
