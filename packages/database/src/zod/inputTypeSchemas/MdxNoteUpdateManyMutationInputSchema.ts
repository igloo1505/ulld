...
export const MdxNoteUpdateManyMutationInputSchema: z.ZodType<Prisma.MdxNoteUpdateManyMutationInput> = z.object({
...
export default MdxNoteUpdateManyMutationInputSchema;
