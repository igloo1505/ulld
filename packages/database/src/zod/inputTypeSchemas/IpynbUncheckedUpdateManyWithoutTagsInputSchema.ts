...
export const IpynbUncheckedUpdateManyWithoutTagsInputSchema: z.ZodType<Prisma.IpynbUncheckedUpdateManyWithoutTagsInput> = z.object({
...
export default IpynbUncheckedUpdateManyWithoutTagsInputSchema;
