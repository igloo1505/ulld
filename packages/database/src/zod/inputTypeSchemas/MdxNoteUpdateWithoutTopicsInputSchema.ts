...
export const MdxNoteUpdateWithoutTopicsInputSchema: z.ZodType<Prisma.MdxNoteUpdateWithoutTopicsInput> = z.object({
...
export default MdxNoteUpdateWithoutTopicsInputSchema;
