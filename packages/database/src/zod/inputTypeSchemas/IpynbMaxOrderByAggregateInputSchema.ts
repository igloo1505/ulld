...
export const IpynbMaxOrderByAggregateInputSchema: z.ZodType<Prisma.IpynbMaxOrderByAggregateInput> = z.object({
...
export default IpynbMaxOrderByAggregateInputSchema;
