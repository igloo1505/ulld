...
export const ToDoUpdateWithoutToDoListInputSchema: z.ZodType<Prisma.ToDoUpdateWithoutToDoListInput> = z.object({
...
export default ToDoUpdateWithoutToDoListInputSchema;
