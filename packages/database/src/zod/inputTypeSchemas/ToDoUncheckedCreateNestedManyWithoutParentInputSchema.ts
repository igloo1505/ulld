...
export const ToDoUncheckedCreateNestedManyWithoutParentInputSchema: z.ZodType<Prisma.ToDoUncheckedCreateNestedManyWithoutParentInput> = z.object({
...
export default ToDoUncheckedCreateNestedManyWithoutParentInputSchema;
