...
export const ToDoUncheckedUpdateManyWithoutParentInputSchema: z.ZodType<Prisma.ToDoUncheckedUpdateManyWithoutParentInput> = z.object({
...
export default ToDoUncheckedUpdateManyWithoutParentInputSchema;
