...
export const HealthReportAvgOrderByAggregateInputSchema: z.ZodType<Prisma.HealthReportAvgOrderByAggregateInput> = z.object({
...
export default HealthReportAvgOrderByAggregateInputSchema;
