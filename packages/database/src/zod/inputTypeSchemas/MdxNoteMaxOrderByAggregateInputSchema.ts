...
export const MdxNoteMaxOrderByAggregateInputSchema: z.ZodType<Prisma.MdxNoteMaxOrderByAggregateInput> = z.object({
...
export default MdxNoteMaxOrderByAggregateInputSchema;
