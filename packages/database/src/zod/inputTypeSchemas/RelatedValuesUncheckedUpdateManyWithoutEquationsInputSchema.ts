...
export const RelatedValuesUncheckedUpdateManyWithoutEquationsInputSchema: z.ZodType<Prisma.RelatedValuesUncheckedUpdateManyWithoutEquationsInput> = z.object({
...
export default RelatedValuesUncheckedUpdateManyWithoutEquationsInputSchema;
