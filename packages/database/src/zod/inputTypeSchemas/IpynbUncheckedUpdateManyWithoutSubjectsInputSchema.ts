...
export const IpynbUncheckedUpdateManyWithoutSubjectsInputSchema: z.ZodType<Prisma.IpynbUncheckedUpdateManyWithoutSubjectsInput> = z.object({
...
export default IpynbUncheckedUpdateManyWithoutSubjectsInputSchema;
