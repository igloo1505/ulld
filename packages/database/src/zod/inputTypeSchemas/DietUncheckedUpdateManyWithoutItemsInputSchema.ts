...
export const DietUncheckedUpdateManyWithoutItemsInputSchema: z.ZodType<Prisma.DietUncheckedUpdateManyWithoutItemsInput> = z.object({
...
export default DietUncheckedUpdateManyWithoutItemsInputSchema;
