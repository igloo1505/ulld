...
export const BibEntryCreateWithoutIpynbNotesInputSchema: z.ZodType<Prisma.BibEntryCreateWithoutIpynbNotesInput> = z.object({
  id: z.string(),
...
export default BibEntryCreateWithoutIpynbNotesInputSchema;
