...
export const DietaryItemCountOrderByAggregateInputSchema: z.ZodType<Prisma.DietaryItemCountOrderByAggregateInput> = z.object({
...
export default DietaryItemCountOrderByAggregateInputSchema;
