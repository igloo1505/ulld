...
export const EquationUncheckedUpdateWithoutTopicsInputSchema: z.ZodType<Prisma.EquationUncheckedUpdateWithoutTopicsInput> = z.object({
...
export default EquationUncheckedUpdateWithoutTopicsInputSchema;
