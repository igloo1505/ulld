import { licenseUnion } from '../../chunk-WQS6PEOH.js';
import '../../chunk-F3FYYIAV.js';
import { z } from 'zod';

var exportFieldObject = z.object({
  types: z.string().optional(),
  import: z.string().optional(),
  require: z.string().optional()
});
var ulldCompletePackageJsonSchema = z.object({
  name: z.string().max(214).refine((a) => {
  ...
  keywords: z.string().array().default(["ulld-plugin"]).transform((a) => {
...
export { ulldCompletePackageJsonSchema };
//# sourceMappingURL=out.js.map
//# sourceMappingURL=packageJsonType.js.map