...
// src/types/corePageUtils/zod.ts
...
// src/types/corePageUtils/zod.ts
var paginationProps = zod.z.object({
  page: zod.z.number().int().default(1),
  take: zod.z.number().int().default(20)
});
var sortDirProps = zod.z.object({
  sortDir: zod.z.union([zod.z.literal("asc"), zod.z.literal("desc")]).default("desc")
});
var equationSearchParamsSchema = zod.z.object({
  tags: zod.z.union([zod.z.string(), zod.z.string().array()]).transform(ArrayUtilities.beArray).default([]),
  variables: zod.z.union([zod.z.string(), zod.z.string().array()]).transform(ArrayUtilities.beArray).default([]),
  query: zod.z.string().optional(),
  value: zod.z.string().optional(),
  orderBy: zod.z.union([
    zod.z.literal("title"),
    zod.z.literal("createdAt")
  ]).default("title")
}).merge(paginationProps).merge(sortDirProps);

exports.equationSearchParamsSchema = equationSearchParamsSchema;
exports.paginationProps = paginationProps;
exports.sortDirProps = sortDirProps;
