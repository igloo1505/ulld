...
export declare const getInternalPackageRecord: () => Record<InternalAppName, InternalPackageItem>;
...
export declare const getInternalPackagesToTranspile: () => InternalAppName[];
