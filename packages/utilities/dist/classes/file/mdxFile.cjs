...
var grayMatter__default = /*#__PURE__*/_interopDefault(grayMatter);
var fs__default = /*#__PURE__*/_interopDefault(fs);
var path__default = /*#__PURE__*/_interopDefault(path);

// src/classes/file/mdxFile.ts
var FileData = class {
...
var MdxFile = class extends FileData {
  ...
  parseFrontMatter() {
    ...
    let gm = grayMatter__default.default(content);
