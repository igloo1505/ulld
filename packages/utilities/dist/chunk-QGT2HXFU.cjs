...
}`),o=({type:a="all"})=>{let r={chtml:a==="all"?!0:a.includes("chtml"),svg:a==="all"?!0:a.includes("svg"),config:a==="all"?!0:a.includes("config")};return t__default.default.createElement(t__default.default.Fragment,null,r.config&&t__default.default.createElement(i,null),r.svg&&t__default.default.createElement(l,null),r.chtml&&t__default.default.createElement(s,null))};o.displayName="MathjaxLoader";var m=o;
...
//# sourceMappingURL=chunk-QGT2HXFU.cjs.map