...
export interface ArrayToTypescriptArrayProps<T> extends CommonVariableDeclarationFields, CommonArrayMethods<T> {
    readOnly?: boolean;
    castToType?: string;
}
...
export interface ArrayToTypescriptObjectProps<T> extends CommonVariableDeclarationFields, CommonArrayMethods<T> {
    arr: T[];
...
export interface ArrayToTypeUnionProps<T> extends Omit<CommonVariableDeclarationFields, "typescriptType">, Omit<CommonArrayMethods<T>, "getKey"> {
}
...
export interface GenFileContentItem<K extends keyof DevelopmentOutputFunctionPropMap = keyof DevelopmentOutputFunctionPropMap, J = unknown> {
    fnc: K;
