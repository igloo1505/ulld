...
var deviceTypeValidationMap = {
  ...
  tablet: reactDeviceDetect.isTablet,
  iOS: reactDeviceDetect.isIOS,
  android: reactDeviceDetect.isAndroid,
  smartTv: reactDeviceDetect.isSmartTV,
  macOS: reactDeviceDetect.isMacOs,
  mobileOnly: reactDeviceDetect.isMobileOnly,
  desktop: reactDeviceDetect.isDesktop
};
